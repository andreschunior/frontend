   ...
   <div className="grid grid-cols-3 gap-4">
              ...
              <Link href={"/dashboard/miplan"}>                 
                <div className="mb-6 p-4 bg-gray-100 border rounded-lg">
                        ...
                        <div className="grid grid-cols-3">
                        <div className="flex justify-center items-center rounded-lg p-4">
                            <Image src={imagenInstall} alt="Foto de Perfil" className="w-24 h-24 object-cover rounded-full" />
                        </div>
                        <div className='col-span-2'>                    
                            <p className=" font-semibold "><span className="text-blue-900 font-bold">Servicio: </span> &nbsp; {ultimaFacturaNoPagada?.concepto}</p>
                            <p className="font-semibold "><span className="text-blue-900 font-bold">Dirección de Instalación: </span> &nbsp; </p>
                            <p className="font-semibold "><span className="text-blue-900 font-bold">Email de Instalación: </span> &nbsp;</p>
                            <p className="font-semibold "><span className="text-blue-900 font-bold">Telefono de Instalación: </span> &nbsp; </p>
                        </div>
                        </div>
                </div> 
                </Link>  
                ...
                <div className="mb-6 p-4 bg-gray-100 border rounded-lg">
                        ...
                        <div className="grid grid-cols-3">
                        <div className="flex justify-center items-center rounded-lg p-4">
                            <Image src={imagenFact} alt="Foto de Perfil" className="w-24 h-24 object-cover rounded-full" />
                        </div>
                        <div className='col-span-2'>                    
                            ...
                            <p className="font-semibold "><span className="text-blue-900 font-bold">Fecha Vencimiento: </span> &nbsp;  {new Date(ultimaFacturaNoPagada?.fechaVencimiento ?? '').toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
                            <p className="font-semibold "><span className="text-blue-900 font-bold">Importe: </span> &nbsp; $ {ultimaFacturaNoPagada?.importe}</p>
                        </div>
                        </div>
                </div>  
                </Link>  
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="h-[420px]  bg-gray-100 border rounded-lg p-4">
                    <h2 className="text-lg font-semibold mb-2">HISTORIAL DE FACTURACIÓN</h2>
                ...
                <div className="h-[420px]  mb-6 p-4 bg-gray-100 border rounded-lg">
                        <h2 className="text-lg font-bold mb-2">DETALLES DEL TOTAL A PAGAR:</h2>
                          <br />                 
                        <p className=" font-semibold "><span className="text-blue-900 font-bold">Servicio: </span> &nbsp; {ultimaFacturaNoPagada?.concepto}</p>
            ...
            {/* Tercer Bloque: HISTORIAL DE FACTURAS */}
                 <div className="  mb-6 p-16 bg-gray-100 border rounded-lg">
                        <h2 className="text-lg font-bold mb-2">DETALLES DEL HISTORIAL DE FACTURACIÓN:</h2>
                          <br />                 
